...
const ScrollNavbar = () => {
  ...
  return (
    <div
      className={`fixed top-0 left-0 right-0 z-50 w-full px-12 py-6 transition-transform duration-300 ease-in-out ${
        isVisible ? "translate-y-0" : "-translate-y-full"
      }`}
    >
      <div className="nav-overlay-shell mx-auto w-full max-w-[1500px]">
