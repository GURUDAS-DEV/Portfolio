      ...
      >
        ...
        <AnimatePresence mode="wait" custom={dir}>
          <motion.div
            ...
            className="relative z-10 flex flex-col md:flex-row min-h-105"
          >
            {/* â”€â”€ LEFT: Text content â”€â”€ */}
            <div className="flex flex-col justify-between p-8 md:p-10 md:w-[55%]">
              {/* Top meta row */}
              ...
              <div className="flex-1 flex flex-col justify-center">
                <h2 className="text-5xl sm:text-6xl lg:text-7xl font-black leading-none tracking-tight text-black mb-6 uppercase">
                  {p.title}
                </h2>

                <p className="text-sm sm:text-base leading-relaxed text-black/70 max-w-sm mb-8 font-medium">
                  {p.description}
                </p>
